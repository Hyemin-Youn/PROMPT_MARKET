...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        "data-[active=true]:border-ring data-[active=true]:ring-ring/50 data-[active=true]:aria-invalid-destructive/20 dark-[active=true]:aria-invalid-destructive/40 aria-invalid-destructive data-[active=true]:aria-invalid-destructive dark-input/30 border-input relative flex h-9 w-9 items-center justify-center border-y border-r text-sm bg-input-background transition-all outline-none first-l-md first-l last-r-md data-[active=true]:z-10 data-[active=true]:ring-[3px]",
        className,
      )}
      {...props}
    >
