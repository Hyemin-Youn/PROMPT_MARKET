  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 sm-cols-3 gap-8 mb-8">
          {/* 브랜드 */}
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["프롬프트 마켓", "프롬프트 등록", "내 구매 내역", "회원가입"].map((item) => (
                <li key={item}>
                  <button
                    className="text-xs hover-80 transition-opacity"
        ...
        {/* 하단 */}
        <div
          className="pt-6 flex flex-col sm-row items-center justify-between gap-2"
